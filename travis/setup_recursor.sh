...
cp "${TRAVIS_BUILD_DIR}/travis/recursor.lua" "/etc/powerdns/recursor.lua"

# Since killing the systemd-resolved also kills Travis we most change
# the default port of the recursor....
